...
const Contact = () => {
      return (
            <div className="text-white my-16 max-w-7xl px-5 lg:px-1 mx-auto">
                  <div className="text-center">
                        <h2 className="text-3xl font-bold my-4">Countact Us</h2>
                        <p className="lg:px-64 my-6 text-slate-300 text-base">Welcome to the Hackathon event! We're thrilled to have you on this exciting journey of innovation, collaboration, and creativity. If you have any questions, need assistance, or would like to connect with our team, you've come to the right place.</p>
                  ...
                  <div>
                        <form className="flex flex-col text-black text-center px-5 lg:px-1 my-16 gap-8" action="">
